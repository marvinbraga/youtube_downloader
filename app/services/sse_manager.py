...
class DownloadEvent:
    ...
    audio_id: str
    event_type: (
        str  # download_started, download_progress, download_completed, download_error
    )
...
class SSEManager:
    ...
    async def download_progress(
        self, audio_id: str, progress: int, message: str = None
    ):
    ...
    async def download_completed(
        self, audio_id: str, message: str = "Download concluído"
    ):
